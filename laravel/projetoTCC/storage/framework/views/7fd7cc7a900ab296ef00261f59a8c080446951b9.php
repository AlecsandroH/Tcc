...
<head>
    ...
    <link rel="icon" href="<?php echo e(asset('favicons/favicon-16x16.png')); ?>" type="image/png">
    <link rel="icon" href="<?php echo e(asset('favicons/favicon-32x32.png')); ?>" type="image/png">
    ...
    <link href="<?php echo e(asset('css/atividades.css')); ?>" rel="stylesheet">
        ...
        <div id="carouselGames" class="carousel slide" data-bs-ride="carousel" data-bs-interval="5000">
            ...
            <div class="carousel-inner">
                ...
                <div class="carousel-item active">
                    <div class="game-card">
                        <img src="<?php echo e(asset('imagens/cores.jpg')); ?>" class="d-block w-100 game-img" alt="Jogo das Cores">
                        <div class="game-body">
                            <h4 class="game-title">Jogo das Cores</h4>
                            <p class="textos-var2">Aprenda cores de forma divertida</p>
                            <br/>
                            <a href="<?php echo e(route('jogo.cores')); ?>" class="btn play-btn"><span class="textos-var2">Jogar Agora</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <div class="game-card">
                        <img src="<?php echo e(asset('imagens/memoria.jpg')); ?>" class="d-block w-100 game-img" alt="Jogo da Memória">
                        <div class="game-body">
                            <h4 class="game-title">Jogo da Memória</h4>
                            <p class="textos-var2">Desenvolva sua memória visual</p>
                            <br/>
                            <a href="<?php echo e(route('jogo.memoria')); ?>" class="btn play-btn"><span class="textos-var2">Jogar Agora</span></a>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <div class="game-card">
                        <img src="<?php echo e(asset('imagens/objetos.jpg')); ?>" class="d-block w-100 game-img" alt="Caça ao Objeto">
                        <div class="game-body">
                            <h4 class="game-title">Caça ao Objeto</h4>
                            <p class="textos-var2">Encontre os objetos escondidos</p>
                            <a href="<?php echo e(route('jogo.objetos')); ?>" class="btn play-btn">Jogar Agora</a>
                        </div>
                    </div>
                </div>
                ...
                <div class="carousel-item">
                    <div class="game-card">
                        <img src="<?php echo e(asset('imagens/quebra.jpg')); ?>" class="d-block w-100 game-img" alt="Quebra-Cabeça">
                        <div class="game-body">
                            <h4 class="game-title">Quebra-Cabeça</h4>
                            <p class="font">Monte peças e divirta-se</p>
                            <a href="<?php echo e(route('jogo.quebra')); ?>" class="btn play-btn">Jogar Agora</a>
                        </div>
                    </div>
                </div>
            </div>
...
</html><?php /**PATH C:\Users\STI\Documents\GitHub\Nova pasta\Tcc\laravel\projetoTCC\resources\views/atividades.blade.php ENDPATH**/ ?>