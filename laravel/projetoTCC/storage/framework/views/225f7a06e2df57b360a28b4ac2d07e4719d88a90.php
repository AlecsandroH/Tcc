...
<head>
    ...
    <link href="<?php echo e(asset('css/textos.css')); ?>" rel="stylesheet">
     <link href="<?php echo e(asset('css/carroseulinicio.css')); ?>" rel="stylesheet">
...
<p>Dedicamos esse espaço ao apoio e comunidade reunindo recursos e informações relacionadas ao TEA, valorizando o que é importante para o desenvolvimento e cotidiano.</p>
    ...
    <div class="pages-wrapper" id="pagesWrapper">
        <div class="page-card">
            <img src="<?php echo e(asset('imagens/cores.jpg')); ?>" alt="Tutorial">
            <div class="page-body">
                <h4>Tutorial</h4>
        ...
        <div class="page-card">
            <img src="<?php echo e(asset('imagens/memoria.jpg')); ?>" alt="Sobre nós">
            <div class="page-body">
                <h4>Sobre Nós</h4>
        ...
        <div class="page-card">
            <img src="<?php echo e(asset('imagens/objetos.jpg')); ?>" alt="Atividades">
            <div class="page-body">
                <h4>Atividades</h4>
        ...
        <div class="page-card">
            <img src="<?php echo e(asset('imagens/quebra.jpg')); ?>" alt="Convivendo com TEA">
            <div class="page-body">
        ...
        <div class="page-card">
            <img src="<?php echo e(asset('imagens/quebra.jpg')); ?>" alt="Autismo">
            <div class="page-body">
...
</html><?php /**PATH C:\Users\STI\Documents\GitHub\Nova pasta\Tcc\laravel\projetoTCC\resources\views/home.blade.php ENDPATH**/ ?>