...
<p>Dedicamos esse espaço ao apoio e comunidade reunindo recursos e informações relacionadas ao TEA, valorizando o que é importante para o desenvolvimento e cotidiano.</p>
    ...
    <div class="div-inicio-direitos">
        <div class="div-direitos-texto">
           <h3>Informando, aprendendo e entendendo</h3>
            <p>É imporante entender que cada pessoa, cada criança tem tem comportamentos, focos
            <br> e gostos diferentes, pensando nisso, nosso site possuí um espaço de comunicação, o FÓRUM, onde você pode responder a dúvidas e fazer suas perguntas!</p>
        </div>
...
<a href="{{ route('forum.login') }}" class="btn btn-primary">
    Entrar no Fórum
</a>
